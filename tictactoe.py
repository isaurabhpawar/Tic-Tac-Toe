...
def check_win(board,x_o):
    if board[0] == x_o and board[1] == x_o and board[2] == x_o:
        ...
        print('{} won the game!'.format(x_o))
        play = False
    elif board[1] == x_o and board[4] == x_o and board[5] == x_o:
        print('{} won the game!'.format(x_o))
        play = False
...
draw_board(board)
play = True
comp_frnd = input("Select 'c' for Computer and 'f' for Friend")
